...
class VoyageDisponible extends Component {
    state = {
        codeVoyage:'',
        codePromo:''
      };
        ...
        const { codePromo, codeVoyage} = this.state
          return(
            ...
            <SectionContainer noBorder header=''>
              ...
              <NavLink to="/reserveSuit"><button className="w3-btn w3-white w3-xlarge" style={{width:'33.3%'}}>
...
export default VoyageDisponible;      